...
*  `org.fmi-standard.fmi-ls-struct.domainInput` : this defines the operating point. The domain_input isn't required to be a scalar, it could be variable with several dimensions.
