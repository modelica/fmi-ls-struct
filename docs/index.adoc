...
Copyright (C) 2024-2026 The Modelica Association Project FMI.
...
Corresponding variable pairs may have different data types from other pairs.
...
The data type of a `codomainOutput` variable shall be identical to the data type of the corresponding `codomain` variable.
Corresponding variable pairs may have different data types from other pairs.

NOTE: A sampled map may contain domain and codomain variables with heterogeneous data types.
No restriction is imposed that all domain variables, or all codomain variables, have the same data type.
For example, the domain variables could be of type `Float32` while the codomain variables could be of type `Int16`.
...
[[rectilinear_example]]
.Example of a 2-dimensional map on a rectilinear grid
image::images/regular-2-d.svg[width=300]
...
----
<!-- ... -->
include::examples/modelDescription.xml[tags=variables]
<!-- ... -->
----
...
image::images/irregular-3-d.svg[width=300]
...
----
<!-- ... -->
include::examples/irregular3d_modelDescription.xml[tags=variables]
<!-- ... -->
----
...
image::images/irregular-2-d.svg[width=200]
...
----
<!-- ... -->
include::examples/irregular2d_modelDescription.xml[tags=variables]
<!-- ... -->
----
